<template>
  <div class="min-h-screen flex items-center justify-center relative bg-cover bg-center"
    ...
    <!-- Form đăng ký nằm ở giữa với độ trong suốt -->
  ...
  <input type="file" accept="image/*"
    ...
    class="w-full p-3 border border-[#8B4513] rounded bg-white focus:outline-none focus:ring-2 focus:ring-[#8B4513]" />
        ...
        <div class="space-y-4">
          ...
          <div class="mt-6 flex flex-col items-start gap-4 overflow-hidden rounded-md p-6 shadow-sm shadow-[#00000050]">
          ...
          <div>
            ...
            <input v-model="form.phone" type="tel" required
              class="w-full p-3 border border-[#8B4513] rounded focus:outline-none focus:ring-2 focus:ring-[#8B4513] mb-4">
          </div>
        </div>
